...
awsMqttClient.on("message", (topic, raw_message, raw_msg, t = mqttWildcard(topic, "notify/out/+"), message = t ? message_parser(raw_message).toLowerCase() : null) => {
  ...
  if (message === light_messages.lounge_1_on.toLowerCase()) zwave_helper(thing_lookup["Lounge lights"], { user: { "Instance 1: Switch": true } })
  if (message === light_messages.lounge_2_on.toLowerCase()) zwave_helper(thing_lookup["Lounge lights"], { user: { "Instance 2: Switch": true } })
  if (message === light_messages.kitchen_1_on.toLowerCase()) zwave_helper(thing_lookup["Kitchen lights"], { user: { "Instance 1: Level": 99 } })
  if (message === light_messages.kitchen_2_on.toLowerCase()) zwave_helper(thing_lookup["Kitchen counter lights"], { user: { "Instance 1: Switch": true } })
  if (message === light_messages.kitchen_3_on.toLowerCase()) zwave_helper(thing_lookup["Kitchen counter lights"], { user: { "Instance 2: Switch": true } })
  if (message === light_messages.kitchen_4_on.toLowerCase()) zwave_helper(thing_lookup["Dining lights"], { user: { "Instance 1: Switch": true } })
  if (message === light_messages.garden_on.toLowerCase()) zwave_helper(thing_lookup["Dining lights"], { user: { "Instance 2: Switch": true } })
  if (message === light_messages.garage_1_on.toLowerCase()) zwave_helper(thing_lookup["Garage lights"], { user: { "Instance 1: Switch": true } })
  if (message === light_messages.garage_2_on.toLowerCase()) zwave_helper(thing_lookup["Garage lights"], { user: { "Instance 2: Switch": true } })
  if (message === light_messages.entry_light_1_on.toLowerCase()) zwave_helper(thing_lookup["Entry lighting"], { user: { "Instance 1: Switch": true } })
  if (message === light_messages.entry_light_2_on.toLowerCase()) zwave_helper(thing_lookup["Entry lighting"], { user: { "Instance 2: Switch": true } })
  if (message === light_messages.fairy_garden_on.toLowerCase()) zwave_helper(thing_lookup["Fairy garden lights"], { user: { "Instance 1: Switch": true } })
  if (message === light_messages.noah_light_on.toLowerCase()) zwave_helper(thing_lookup["Noah lighting"], { user: { "Instance 1: Switch": true } })
  if (message === light_messages.loo_on.toLowerCase()) zwave_helper(thing_lookup["Loft bathroom"], { user: { "Instance 1: Level": 20 } })

  if (message === light_messages.lounge_1_off.toLowerCase()) zwave_helper(thing_lookup["Lounge lights"], { user: { "Instance 1: Switch": false } })
  if (message === light_messages.lounge_2_off.toLowerCase()) zwave_helper(thing_lookup["Lounge lights"], { user: { "Instance 2: Switch": false } })
  if (message === light_messages.kitchen_1_off.toLowerCase()) zwave_helper(thing_lookup["Kitchen lights"], { user: { "Instance 1: Level": 0 } })
  if (message === light_messages.kitchen_2_off.toLowerCase()) zwave_helper(thing_lookup["Kitchen counter lights"], { user: { "Instance 1: Switch": false } })
  if (message === light_messages.kitchen_3_off.toLowerCase()) zwave_helper(thing_lookup["Kitchen counter lights"], { user: { "Instance 2: Switch": false } })
  if (message === light_messages.kitchen_4_off.toLowerCase()) zwave_helper(thing_lookup["Dining lights"], { user: { "Instance 1: Switch": false } })
  if (message === light_messages.garden_off.toLowerCase()) zwave_helper(thing_lookup["Dining lights"], { user: { "Instance 2: Switch": false } })
  if (message === light_messages.garage_1_off.toLowerCase()) zwave_helper(thing_lookup["Garage lights"], { user: { "Instance 1: Switch": false } })
  if (message === light_messages.garage_2_off.toLowerCase()) zwave_helper(thing_lookup["Garage lights"], { user: { "Instance 2: Switch": false } })
  if (message === light_messages.entry_light_1_off.toLowerCase()) zwave_helper(thing_lookup["Entry lighting"], { user: { "Instance 1: Switch": false } })
  if (message === light_messages.entry_light_2_off.toLowerCase()) zwave_helper(thing_lookup["Entry lighting"], { user: { "Instance 2: Switch": false } })
  if (message === light_messages.fairy_garden_off.toLowerCase()) zwave_helper(thing_lookup["Fairy garden lights"], { user: { "Instance 1: Switch": false } })
  if (message === light_messages.noah_light_off.toLowerCase()) zwave_helper(thing_lookup["Noah lighting"], { user: { "Instance 1: Switch": false } })
  if (message === light_messages.loo_off.toLowerCase()) zwave_helper(thing_lookup["Loft bathroom"], { user: { "Instance 1: Level": 0 } })

  if (message === light_messages.kitchen_1_on_25.toLowerCase()) zwave_helper(thing_lookup["Kitchen lights"], { user: { "Instance 1: Level": 25 } })
  if (message === light_messages.kitchen_1_on_50.toLowerCase()) zwave_helper(thing_lookup["Kitchen lights"], { user: { "Instance 1: Level": 50 } })
  if (message === light_messages.kitchen_1_on_75.toLowerCase()) zwave_helper(thing_lookup["Kitchen lights"], { user: { "Instance 1: Level": 75 } })
